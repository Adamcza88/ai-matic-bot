...
const SettingsPanel = ({ settings, onUpdateSettings, onClose }) => {
    ...
    const coreProfiles = {
        "ai-matic": {
            ...
            description: "Core engine: multi‑TF OB/POI + EMA 20/50/200 bez křížení + pattern/volume gating.",
            notes: [
                ORDER_VALUE_NOTE,
        ...
        "ai-matic-x": {
            ...
            notes: [
                ...
                "• Trailing SL: aktivace dle profilu (R-based / retracement).",
                "⸻",
    ...
    const aiMaticGateNames = [
        ...
        "Entry: GAP present",
        "Entry: RSI/MACD",
        "Checklist: HTF EMA trend",
        "Checklist: MTF EMA confirm",
        "Checklist: EMA 20/50/200 stack",
        "Checklist: EMA no-cross",
        "Checklist: Pattern confirm",
        "Checklist: Volume confirm",
    ...
    const statusItems = [
        ...
        {
            label: "Trend gate",
            value: local.riskMode === "ai-matic-pro" ? "Off (PRO)" : local.trendGateMode,
        },
