  ...
  const coreProfiles: Record<AISettings["riskMode"], CoreProfile> = {
    ...
    "ai-matic-x": {
      ...
      notes: [
        ...
        "Vsechny tri podminky A/B/C musi byt splneny.",
        "Zakazy: zadny mid-to-mid bez rejekce, zruseni po TTL, zruseni po HTF close pres M1.",
        "Zakazy: nevstupovat proti BTC kontextu.",
        "Exekuce: SL za mikro-swing/OB nebo 1.0x ATR(LTF).",
        "Exekuce: TP1 1R, TP2 2R, zbytek trail, trailing stop 0.5x ATR, TTR cil pod 60s.",
      ],
    },
    "ai-matic-amd": {
    ...
    "ai-matic-olikella": {
      ...
      notes: [
        ...
        "FVG: velikost >= 0.20 ATR + návrat max 50%.",
        "ENTRY CONDITIONS",
