...
export default function Dashboard({ mode, setMode, useTestnet, setUseTestnet, bot, }) {
    ...
    const aiMatic = {
        ...
        "Entry: RSI/MACD": true,
        "Checklist: HTF EMA trend": true,
        "Checklist: MTF EMA confirm": true,
        "Checklist: EMA 20/50/200 stack": true,
        "Checklist: EMA no-cross": true,
        "Checklist: Pattern confirm": true,
        "Checklist: Volume confirm": true,
