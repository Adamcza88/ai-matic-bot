                                                ...
                                                : "border-border/60 text-muted-foreground", children: ["Feed age ", feedAgeLabel, " \u00B7 ", feedAgeValue] }), isManage ? (_jsx(Badge, { variant: "outline", className: "border-amber-500/50 text-amber-400", children: `MANAGE${manageReason ? ` \u00B7 ${manageReason}` : ""}` })) : null, _jsxs(Badge, { variant: "outline", className: "border-border/60 text-muted-foreground", children: ["Mode ", MODE_LABELS[mode]] })] }), _jsxs("div", { className: "flex items-center gap-2 text-muted-foreground", children: [_jsx(Badge, { variant: "outline", className: signalClass, children: signalLabel }), _jsx(ChevronDown, { className: "h-4 w-4 text-muted-foreground transition-transform group-open:rotate-180" })] })] }), _jsx("div", { className: "border-t border-border/60 px-4 py-3 text-xs", children: !scanLoaded ? (_jsx("div", { className: "text-muted-foreground", children: "Loading diagnostics..." })) : gates.length === 0 ? (_jsx("div", { className: "text-muted-foreground", children: "No scan data for this symbol." })) : (_jsxs("div", { className: "space-y-3", children: [_jsxs("div", { className: "grid gap-2 sm:grid-cols-2", children: [_jsxs("div", { className: "flex items-center gap-2", children: [_jsx("span", { className: `h-2 w-2 rounded-full ${hardEnabled
                                                            ...
                                                            : "bg-slate-600"}` }), _jsxs("span", { className: softEnabled ? "text-foreground" : "text-muted-foreground", children: ["Soft score:", " ", softEnabled
                                                                ? qualityScore != null
                                                                    ...
                                                                    : "—"
                                                                : "OFF"] })] }), isManage ? (_jsxs("div", { className: "flex items-center gap-2", children: [_jsx("span", { className: "h-2 w-2 rounded-full bg-amber-400" }), _jsxs("span", { className: "text-foreground", children: ["Manage: ", manageReason ?? "active"] })] })) : null] }), _jsxs("div", { className: "grid gap-2 sm:grid-cols-2", children: [proState ? (_jsxs("div", { className: "flex items-center gap-2", children: [_jsx("span", { className: "h-2 w-2 rounded-full bg-sky-400" }), _jsxs("span", { className: "text-foreground", children: ["PRO state: ", proState] })] })) : null, manipActive != null ? (_jsxs("div", { className: "flex items-center gap-2", children: [_jsx("span", { className: "h-2 w-2 rounded-full " + (manipActive ? "bg-amber-400" : "bg-emerald-400") }), _jsxs("span", { className: "text-foreground", children: ["Manipulation ", manipActive ? "ON" : "OFF"] })] })) : null, liqProximity != null ? (_jsxs("div", { className: "flex items-center gap-2", children: [_jsx("span", { className: "h-2 w-2 rounded-full bg-violet-400" }), _jsxs("span", { className: "text-foreground", children: ["Liq proximity ", Number.isFinite(liqProximity) ? String(liqProximity.toFixed(2)) + "%" : "—"] })] })) : null] }), _jsxs("div", { className: "grid gap-2 sm:grid-cols-2", children: [gates.map((gate) => (_jsxs("button", { type: "button", onClick: () => toggleChecklist(gate.name), className: "flex items-center gap-2 text-left", title: "Toggle gate enforcement for this check.", children: [_jsx("span", { className: `h-2 w-2 rounded-full ${!((checklistEnabled[gate.name] ?? true)) || gate.detail === "not required" || (!signalActive && !gate.ok) ? "bg-slate-600" : gate.ok ? "bg-emerald-400" : "bg-red-400"}` }), _jsx("span", { className: (checklistEnabled[gate.name] ?? true)
                                                        ? "text-foreground"
