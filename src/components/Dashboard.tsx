...
export default function Dashboard({
  ...
  const CHECKLIST_DEFAULTS_BY_PROFILE = useMemo(() => {
    ...
    const aiMatic = {
      ...
      "Entry: Sweep return": true,
      "Entry: OB reaction": true,
      "Entry: OB retrace": true,
      "Entry: GAP present": true,
      "Entry: RSI/MACD": true,
      "Checklist: Likvidita (sweep)": true,
      "Checklist: Reakce na 1h support/OB": true,
      "Checklist: Close nad/pod OB open": true,
      "Checklist: Přítomen GAP": true,
      "Checklist: Retracement zpět do OB zóny": true,
      "Checklist: Pattern 15m": true,
      "Checklist: RSI/MACD": true,
      "Exec allowed": true,
    };
    return {
      "ai-matic": aiMatic,
