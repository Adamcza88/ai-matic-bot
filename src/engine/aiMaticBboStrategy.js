...
export function evaluateAiMaticBboStrategyForSymbol(symbol, candles) {
    ...
    const coreV2 = {
        ...
        atr14: atr5,
        atrPct: Number.isFinite(atr5) && Number.isFinite(entry) && entry > 0 ? atr5 / entry : Number.NaN,
        sep1: Number.isFinite(atr5) && atr5 > 0 && Number.isFinite(ema12) && Number.isFinite(ema26)
            ? Math.abs(ema12 - ema26) / atr5
            : Number.NaN,
        sep2: Number.isFinite(atr5) && atr5 > 0 && Number.isFinite(ema26) && Number.isFinite(ema50)
        ...
        volumeTodThreshold: Number.isFinite(recentVolumeAvg) ? recentVolumeAvg * VOLUME_SPIKE_MIN : Number.NaN,
        ...
        ltfRange: Number.isFinite(latestM5?.high) && Number.isFinite(latestM5?.low)
        ...
        m15EmaSpreadPct: Number.isFinite(m15Trend.fastNow) &&
