export const STRATEGY_CHEAT_SHEET = [
    ...
    },
    {
        ...
        description: "Smart Money deep integration for intraday scalps with EMA/OB alignment, sweeps, retests, and multi-TF confirmation.",
        entryType: "LIMIT_MAKER_FIRST",
        side: "both",
        priority: 3,
        rules: [
            ...
            "Liquidity sweep/inducement: nevstupuj na pruraz, cekej na navrat + objemovou reakci + pattern.",
            "Break & retest: vstup az po retestu OB / S&R / PoC, ne na prvni impuls.",
            "FVG: SL davat za FVG, TP smerovat k FVG/OB/S&R v ceste.",
            "Multi-TF: BOS/CHoCH na 1h i 15m, vstupni pattern na 5m nebo 1m.",
            "Management: opacny BOS/CHoCH na 1m/5m = rucni exit, necekas na SL/TP.",
            "Workflow: trend + struktura -> OB + sweep -> pattern + volume -> entry -> SL/TP -> sprava.",
            "Chyby: OB bez EMA, vstup bez sweepu/retestu, SL v likvidite, ignorace struktury.",
        ],
    },
    {
