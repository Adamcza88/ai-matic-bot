export const STRATEGY_CHEAT_SHEET = [
    {
        ...
        description: "AI-MATIC TF stack (HTF 1h/15m + LTF 5m) + EMA 20/50/200 + OB/POI priority.",
        entryType: "LIMIT_MAKER_FIRST",
        side: "both",
        priority: 1,
        rules: [
            "HTF 1h: OB zóny + EMA20/50/200 trend + S/R + volume.",
            "MTF 15m: trend/EMA potvrzení pro vstup.",
            "LTF 5m: OB reakce + RSI/MACD potvrzení.",
            "Entry 1 (60 %): první reakce z OB nebo sweep návrat.",
            "Entry 2 (40 %): retest OB / GAP fill / Fibo 61.8.",
    ...
    },
    {
        ...
        rules: [
          ...
          "- Extension: 38.2%, 61.8%, 100%, 138.2%, 161.8% These zones often become self-fulfilling levels",
