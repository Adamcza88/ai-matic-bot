export const UI_COPY = {
  ...
  dashboard: {
    ...
    gateStatus: {
      ...
      BLOCKED: "Blokovaný",
      DISABLED: "Vypnutý",
      waitingDetail: "čeká na vyhodnocení filtru",
      noDetail: "bez detailu",
      entryProgressTitle: "Průběh vstupních filtrů",
      entryReady: "Vstup připraven",
      entryWaiting: "Vstup čeká",
      entryBlocked: "Vstup blokován",
      blockersTitle: "Co blokuje?",
      blockerSystem: "Systém",
      blockerGateBlocked: "Blokace filtru",
      blockerWaiting: "Čeká na signál",
      blockerEmpty: "Bez aktivních blokátorů.",
  ...
  statusBar: {
    ...
    auto: "Auto",
    manual: "Manuál",
    engineRunning: "ENGINE: BĚŽÍ",
    enginePaused: "ENGINE: PAUZA",
